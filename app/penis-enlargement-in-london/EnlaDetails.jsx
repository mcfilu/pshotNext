    ...
    <div className={` flex w-full flex-row     `}>
        ...
        <div className={`hidden md:flex w-[55%] h-[100%]   flex flex-col items-left justify-between md:p-[2vh] pt-[0px] `}>
            <div className={`flex flex-col w-[100%]   items-center justify-center my-auto p-[1vh]`}>
                ...
                <p className={`text-white text-[2.2vh] mt-[5vh] font-main`}><Link href="/o-concept-treatment-in-london/" className="text-gold2 underline">The O Concept™</Link> understands that every man's sexual wellness needs are unique. That's why we offer a tailored and specialised combination of sexual aesthetic treatments, including our penile enlargement in London treatment to effectively address male sexual dysfunction.</p>
                <p className={`flex text-white text-[2.2vh] mt-[1.5vh] font-main`}>The decision to enhance and enlarge your penis is a personal one. With the use of soft tissue fillers, the London penis enlargement procedure provides a long-lasting solution without the potential risks associated with permanent fillers or implants. Our approach ensures a safe and non-invasive experience.</p>
        ...
        <div className={`flex flex-col md:hidden items-center`}>
            ...
            <div className={`flex w-full h-[35vh]`}>
                ...
                <p className={`text-white text-[2.2vh] mt-[5vh] ml-[1vh] font-main`}><Link href="/o-concept-treatment-in-london/" className="text-gold2 underline">The O Concept™</Link> understands that every man's sexual wellness needs are unique. That's why we offer a tailored and specialised combination of sexual aesthetic treatments, including our penile enlargement in London treatment to effectively address male sexual dysfunction.</p>
