            ...
            <div className={` w-[100%] mx-auto h-[100%]`}>
                ...
                <div className={`flex flex-col md:flex-row justify-between px-[3vh] my-[5vh]`}>
                    <div className="inner-item flex flex-col items-center text-white">
                        ...
                        <p className="text-[2.5vh] font-medium mt-[1vh] font-main">Approx 30-45 mins</p>
                    ...
                    <div className="inner-item flex flex-col items-center text-white mt-[5vh] md:mt-[0px] md:w-[35%]">
                        ...
                        {/* <span className="text-[2vh] font-light"></span> */}
                        <p className="text-[2.5vh] font-medium mt-[1vh] font-main text-center">Local (numbing cream / lidocaine injections)</p>
                ...
                <div>
                    ...
                    <div className={`flex flex-row`}>
                        ...
                        <p className="text-[2vh] font-light text-white w-[70%] font-main">Minor bruising, tenderness at injection sites. Redness and swelling.</p>
                    </div>
...
Increased penis girth, approx. 10-15%, both flaccid and erect. 10-15% increase in length in flaccid position.
                        </p>
                    </div>
                    ...
                    <div className={`flex flex-row`}>
                        ...
                        <p className="text-[2vh] font-light text-white w-[70%] font-main">
                        15-18 months, repeat treatments required.
                        </p>
                    </div>
                    <hr className={`mt-[2vh] mb-4`}></hr>
                    <div className={`flex flex-row`}>
...
Return to normal activities immediately, no strenuous exercises for one week.
                        </p>
                    </div>
                    <hr className={`mt-[2vh] mb-4`}></hr>
                    <div className={`flex flex-row`}>
...
Penis swelling will resolve in 24-48 hours, no sexual activity for 2-3 weeks.
                        </p>
                    </div>
                    <hr className={`mt-[2vh] mb-4`}></hr>
                </div>
