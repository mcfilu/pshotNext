    ...
    <div className={` flex w-full flex-row     `}>
        ...
        <div className={`hidden md:flex w-[55%] h-[100%]   flex flex-col items-left justify-between md:p-[2vh] pt-[0px] `}>
            <div className={`flex flex-col w-[100%]   items-center justify-center my-auto p-[1vh]`}>
                ...
                <p className={`flex text-white text-[2.2vh] mt-[1.5vh] font-main`}>The P-Shot® London procedure harnesses the body's natural healing and rejuvenating abilities by injecting Platelet Rich Plasma (PRP), rich in growth factors, into the penis. Similar to the technique used for the Vampire Facelift®, a small amount of blood is taken from the arm and processed in a centrifuge to extract the plasma. This plasma, abundant in cell-regenerating growth factors, is then injected into the penis, triggering stem cells to increase blood flow and promote the growth of healthier tissue.</p>
